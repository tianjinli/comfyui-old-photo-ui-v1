...
Submission: https://comfy.getrunpod.io/dashboard/submissions/kd7339vphjjx0cy3y60pzx5v6h8ce2ay
## Pull the prebuilt image

We've already built and published this image on Docker Hub:

```bash
docker pull runpod/comfyui-wizard:kd7339vphjjx0cy3y60pzx5v6h8ce2ay
docker run --rm --gpus all -p 8188:8188 runpod/comfyui-wizard:kd7339vphjjx0cy3y60pzx5v6h8ce2ay
```
